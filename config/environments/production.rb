Rails.application.configure do
  ...
  config.domain = 'syncserver-vincent.tapngo.orangejapan.jp'
  ...
  #### Logs
  config.logentries_token = '1e5e638b-1dc4-47bf-a7c9-e5d0b8de52d7'

  #### APIs
  config.tr069_api_host = '52.16.103.212'
  config.tr069_api_port = 7557
  config.node_ws_api = 'http://127.0.0.1:3052'
  ...
  # When sending an sms to a phone number, the country of this number must be enabled on the twilio account:
